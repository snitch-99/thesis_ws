# Drone Mapping Package

This package provides a simulation environment and mapping capabilities for a drone using ROS 2, Gazebo, and MAVROS.
...
```bash
sudo apt install ros-humble-depth-image-proc ros-humble-mavros ros-humble-mavros-extras
```
